...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateIndex = function updateIndex() {
	  var list = $('#label-table').children('.label-table__list');
	  var labelIds = _.map(list, function (elem) {
	    console.log(elem);
	...
	$(document).on('change', '.label-table__colorbox__colorList__radio', function () {
	  ...
	  if ($(this).is(':checked')) {
	    ...
	    var x = $(this).parents('.label-table__colorbox__picker');
	    ...
	    $.ajax(jsRoutes.controllers.LabelAuthController.updateColor(id, color)).done(function (result) {
	      console.log('changed.');
	    }).fail();
	  }
	});
	...
	$(document).on('change', '.label-table__name-text', function () {
	  ...
	  //   error: function(){console.log('error.');/*...*/}
	  // });
	  $.ajax(jsRoutes.controllers.LabelAuthController.updateName(id, name)).done(function (result) {
	    console.log('changed.');
	  }).fail();
	});
	...
	$(document).on('click', '[name="label_color"]', function () {
	  ...
	  var y = $('.label-table__colorbox__picker').not(x);
	  if (y) {
	    y.each(function (i, elem) {
	      var z = $(elem).css('display');
	      if (!(z == 'none')) {
	        $(elem).hide();
	      }
	    });
	...
	$('.add-label').click(function () {
	  $.ajax(jsRoutes.controllers.LabelAuthController.newline()).done(function (result) {
	...
	/*...*/$(document).on('click', '[name="remove_label"]', function () {
	  var id = $(this).attr('label-id');
	  var target = $(this).parents('.label-table__list')[0];

	  $.ajax(jsRoutes.controllers.LabelAuthController.remove(id)).done(function (result) {
	    target.remove();
	  });
	});
	...
	$(document).on('click', function (e) {
	  ...
	  var foo = _.some($('.label-table__color'), function (p, i) {
	    var x = $.contains(p, e.target);
	    // console.log(x);
	    return x;
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	if(false) {
		// When the styles change, update the <style> tags
		if(!content.locals) {
			module.hot.accept("!!./../../node_modules/css-loader/index.js!./slick-theme_custmized.css", function() {
				var newContent = require("!!./../../node_modules/css-loader/index.js!./slick-theme_custmized.css");
				if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
				update(newContent);
			});
		}
...
/***/ function(module, exports, __webpack_require__) {
	...
	// module
	exports.push([module.id, "/* for slick */\n/*左右の矢印の色を変える*/\n.slick-prev:before,\n.slick-next:before {\n    color: #000;\n}\n/*左右の矢印の位置を変える*/\n.slick-next {\n  right: 0;\n  left: auto;\n  top: 45px;\n  z-index: 99;\n  transform: rotate(90deg);\n}\n.slick-prev {\n  right: 0;\n  left: auto;\n  top: 5px;\n  z-index: 100;\n  transform: rotate(90deg);\n}\n", ""]);
