...
/***/ function(module, exports) {
	...
	/*! device.js 0.1.61 */
	(function () {
	  var a, b, c, d, e, f, g, h, i, j;a = window.device, window.device = {}, c = window.document.documentElement, j = window.navigator.userAgent.toLowerCase(), device.ios = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	jQuery.fn.CSSAnimate = function (a, b, k, l, f) {
		return this.each(function () {
			var c = jQuery(this);if (0 !== c.length && a) {
				"function" == typeof b && (f = b, b = jQuery.fx.speeds._default);"function" == typeof k && (f = k, k = 0);"function" == typeof l && (f = l, l = "cubic-bezier(0.65,0.03,0.36,0.72)");if ("string" == typeof b) for (var j in jQuery.fx.speeds) {
					if (b == j) {
						b = jQuery.fx.speeds[j];break;
					} else b = null;
				}if (jQuery.support.transition) {
					var e = "",
					    h = "transitionEnd";jQuery.browser.webkit ? (e = "-webkit-", h = "webkitTransitionEnd") : jQuery.browser.mozilla ? (e = "-moz-", h = "transitionend") : jQuery.browser.opera ? (e = "-o-", h = "otransitionend") : jQuery.browser.msie && (e = "-ms-", h = "msTransitionEnd");j = [];for (d in a) {
						var g = d;"transform" === g && (g = e + "transform", a[g] = a[d], delete a[d]);"transform-origin" === g && (g = e + "transform-origin", a[g] = a[d], delete a[d]);j.push(g);c.css(g) || c.css(g, 0);
					}d = j.join(",");c.css(e + "transition-property", d);c.css(e + "transition-duration", b + "ms");c.css(e + "transition-delay", k + "ms");c.css(e + "transition-timing-function", l);c.css(e + "backface-visibility", "hidden");setTimeout(function () {
						c.css(a);
					}, 0);setTimeout(function () {
						c.called || !f ? c.called = !1 : f();
					}, b + 20);c.on(h, function (a) {
						c.off(h);c.css(e + "transition", "");a.stopPropagation();"function" == typeof f && (c.called = !0, f());return !1;
					});
				} else {
					for (var d in a) {
						"transform" === d && delete a[d], "transform-origin" === d && delete a[d], "auto" === a[d] && delete a[d];
					}if (!f || "string" === typeof f) f = "linear";c.animate(a, b, f);
				}
			}
		});
	};jQuery.fn.CSSAnimateStop = function () {
		var a = "",
		    b = "transitionEnd";jQuery.browser.webkit ? (a = "-webkit-", b = "webkitTransitionEnd") : jQuery.browser.mozilla ? (a = "-moz-", b = "transitionend") : jQuery.browser.opera ? (a = "-o-", b = "otransitionend") : jQuery.browser.msie && (a = "-ms-", b = "msTransitionEnd");jQuery(this).css(a + "transition", "");jQuery(this).off(b);
	...
	(function (c) {
		c.extend({ metadata: { defaults: { type: "class", name: "metadata", cre: /({.*})/, single: "metadata" }, setType: function setType(b, c) {
					this.defaults.type = b;this.defaults.name = c;
				}, get: function get(b, f) {
					var d = c.extend({}, this.defaults, f);d.single.length || (d.single = "metadata");var a = c.data(b, d.single);if (a) return a;a = "{}";if ("class" == d.type) {
						var e = d.cre.exec(b.className);e && (a = e[1]);
					} else if ("elem" == d.type) {
						if (!b.getElementsByTagName) return;e = b.getElementsByTagName(d.name);e.length && (a = c.trim(e[0].innerHTML));
					} else void 0 != b.getAttribute && (e = b.getAttribute(d.name)) && (a = e);0 > a.indexOf("{") && (a = "{" + a + "}");a = eval("(" + a + ")");c.data(b, d.single, a);return a;
	...
	/***************************************************************************************/
	if ((typeof ytp === "undefined" ? "undefined" : _typeof(ytp)) != "object") ytp = {};
	...
	(function (jQuery) {
		...
		jQuery.mbYTPlayer = {
			...
			defaults: {
				...
				onStateChange: function onStateChange(player) {},
				onPlaybackQualityChange: function onPlaybackQualityChange(player) {},
	     ...
	     * ***********************************************************/
	          ...
	          */
										...
										if (state == 0) {
											...
											if (!data.loop && YTPlayer.isBackground) YTPlayer.wrapper.CSSAnimate({ opacity: 0 }, 2000);else if (data.loop) {
												YTPlayer.wrapper.css({ opacity: 0 });
												YTPlayer.loop++;
											}
			...
			getDataFromFeed: function getDataFromFeed(videoID, YTPlayer) {
				...
				if (!jQuery.browser.msie) {
					...
					jQuery.getJSON('http://gdata.youtube.com/feeds/api/videos/' + videoID + '?v=2&alt=jsonc', function (data, status, xhr) {
						...
						if (YTPlayer.opt.ratio == "auto") if (videoData.aspectRatio && videoData.aspectRatio === "widescreen") YTPlayer.opt.ratio = "16/9";else YTPlayer.opt.ratio = "4/3";
			...
			YTPlaylist: function YTPlaylist(videos, shuffle, callback) {
				var YTPlayer = this.get(0);
			...
			fullscreen: function fullscreen(real) {
				...
				if (!YTPlayer.isAlone) {
					...
					if (YTPlayer.player.getPlayerState() >= 1) {
						...
						} else videoWrapper.css({ zIndex: 10000 }).CSSAnimate({ opacity: 1 }, 1000, 0);
			...
			setYTPVolume: function setYTPVolume(val) {
				var YTPlayer = this.get(0);
				if (!val && !YTPlayer.opt.vol && player.getVolume() == 0) jQuery(YTPlayer).unmuteYTPVolume();else if (!val && YTPlayer.player.getVolume() > 0 || val && YTPlayer.player.getVolume() == val) jQuery(YTPlayer).muteYTPVolume();else YTPlayer.opt.vol = val;
				YTPlayer.player.setVolume(YTPlayer.opt.vol);
			},

			muteYTPVolume: function muteYTPVolume() {
				var YTPlayer = this.get(0);
			...
			unmuteYTPVolume: function unmuteYTPVolume() {
				var YTPlayer = this.get(0);
